...
public class RobotoCalendarViewOld extends LinearLayout {
...
//            boolean isWeekendDate = new Utils().getWeekendFromDate(calendar.getTime());
...
//            if (!isWeekendDate) {
    ...
    public RobotoCalendarViewOld(Context context) {
        super(context);
        init(null);
    }

    public RobotoCalendarViewOld(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public RobotoCalendarViewOld(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public RobotoCalendarViewOld(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
